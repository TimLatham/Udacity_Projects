 ...
 */
func beginsWithVowel(_ word: String) -> Bool/* define the return type */ {
    /* add function implementation here */
    ...
    if word.isEmpty {
        ...
        for letter in vowels {
            if word.lowercased().hasPrefix(letter) {
                return true
            }
            }
        }
 ...
 */
func funWithWords(_ word: String) -> String/* define the return type */ {
    /* add function implementation here */
