# -*- coding: utf-8 -*-
"""
Created on Wed Feb 08 11:13:32 2017
...
while counter < len(count_list):
    space_count = len("number") - len(str(counter))
    line = ""
    line += " " * space_count
    line += str(counter)
    line += " | "
    line += str(count_list[counter])
    print line
    counter += 1
