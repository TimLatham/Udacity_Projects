# -*- coding: utf-8 -*-
"""
Created on Fri Feb 17 10:08:53 2017
...
def total_enrollment(univs):
    tuition, enrollment, count = 0, 0, 0
    while count < len(univs):
        tuition = tuition + univs[count][1]
        enrollment = enrollment + (univs[count][1] * univs[count][2])
        #print tuition, enrollment, count        
        count += 1
